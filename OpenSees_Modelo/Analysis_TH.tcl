...
set gm_Name_L   "19850303_7.9Mw_33.95S_71.71W_40.7KM_st06_VALP08R_0p0050_Y_23274.txt"; #Este es el registro que se aplica en la direccion Y. Nombre del archivo con el registro longitudinal (debe contener una unica columna con el valor de aceleracion). L=2 y 2 es equivalente a Y
set gm_Name_T   "19850303_7.9Mw_33.95S_71.71W_40.7KM_st06_VALP08R_0p0050_X_23274.txt"; #Este es el registro que se aplica en la direccion X .Nombre del archivo con el registro transversal (debe contener una unica columna con el valor de aceleracion). T=1 y 1 es equivalente a X
...
set dt_Reg      0.005;             #Time-step del par de registros, en segundos.

set secs        [expr 0.005*23274];             #Segundos de duracion a analizar del registro sismico, desde el segundo 0.

set TimeStep    0.005;             #Paso temporal utilizado para el analisis, en segundos.
