...
##################################################Interfaces ##########################################;
#Para poder utilizar el modelo con la configuracion con Interfaz Dilatada se deben comentar las dos secciones siguiente , añadiendo "#" al inicio de cada linea de codigo 
#El modelo solo permite una configuracion a la vez

###########################################################SECCION CON INTERFAZ MONOLITICA###############################################################################################################;
#Interfaz Monolitica 
#Para poder utilizar el modelo con la configuracion con Interfaz Monolitica se debe descomentar esta seccion quitando "#" del inicio de cada linea de codigo en caso de que esten comentados
...
#}
##################################################################SECCION CON DISIPADORES ######################################################################################################;

#Interfaz con disipador 
#Para poder utilizar el modelo con la configuracion con Interfaz con Disipadores se debe descomentar esta seccion quitando "#" del inicio de cada linea de codigo en caso de que esten comentados
